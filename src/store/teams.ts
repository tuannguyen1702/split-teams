...
const data = localStorageGetItem("data")
  ...
  : [
      ...
      ["Quangg  <span class='ml-1 dot-red inline-flex", "A Thành", "A Thái", "A Chung <span class='ml-1 dot-blue inline-flex'>-</span>"],
      ["A Hải <span class='ml-1 dot-red inline-flex'>+</span>", "A Vương <span class='ml-1 dot-blue inline-flex'>-</span>", "Thầy Trình", "A Tân <span class='ml-1 dot-blue inline-flex'>-</span>"],
